        ...
        <div className="overflow-x-auto rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-8">
          <div className="flex flex-col justify-between">
            <div className="flex flex-row justify-center space-x-4">
              <h1 className="text-center text-3xl font-bold">शेतकरी यादी</h1>
              <button
                onClick={clearStorage}
                className={`inline-flex items-center rounded-lg bg-blue-700 px-4 py-2 font-medium text-white hover:bg-blue-400`}
              >
                <svg
            ...
            {searchClicked && (
              <h1 className="font-semi-bold mt-2 text-center text-lg text-red-700">
            ...
            >
              <table
                className="mt-5 min-w-full divide-y-2 divide-gray-200 bg-white text-sm md:block"
                id="my-table"
              >
                <thead className="">
                  <tr className="bg-gray-300">
                    ...
                    <th className="px-1 py-2 text-left font-bold text-gray-900 md:px-12 lg:px-12">
                      मालधन्याचे नाव
                    </th>
                    <th className="whitespace-nowrap px-1 py-2 font-bold text-gray-900 md:px-12 lg:px-12">
                      Mobile Number
                  ...
                  {Boolean(farmers) &&
                    farmers.map((entry, index) => (
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap py-2 text-left text-gray-700">
                          {entry.farmername}
                        </td>
                        <td className="whitespace-nowrap py-2 text-center text-gray-700">
                          {entry.mobilenumber}
                        ...
                        <td className="whitespace-nowrap py-2 text-center text-gray-700">
                          <button
                            ...
                            className={`cursor-pointer rounded-lg bg-red-500 p-2 text-white hover:bg-red-900`}
                          >
                            <svg
                          ...
                          <button
                            className="ml-1 cursor-pointer rounded-lg bg-green-500 p-2 text-white hover:bg-green-900"
                            onClick={(event) => {
                              event.preventDefault();
                              event.stopPropagation();
