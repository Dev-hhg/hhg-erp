		...
		<div className="p-2 md:p-14 lg:p-14">
			<div className="relative rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12 ">
				...
				<div className={`flex  justify-between ${loading ? "opacity-20" : ""}`}>
					<div className={`flex my-6 w-1/2 md:w-3/12 lg:w-3/12 `}>
						<VendorSelect
					...
					<div className="ml-2 flex w-1/2 flex-col md:flex-row">
						<div className="flex items-center mt-2 md:mr-4 md:mt-0">
							<label
								htmlFor="transporter"
								className="font-semibold text-sm text-gray-900 md:mx-5"
							>
								transporterName
							</label>
							<input
								className=" w-1/2 md:w-36 border-0 border-b appearance-none focus:outline-none focus:ring-0 border-gray-200 px-2 py-1 text-center text-sm  "
								type="text"
								id="transporter"
				...
				>
					<table className="min-w-full divide-y-2  divide-gray-200 bg-white text-sm mt-5  md:block">
						<thead className="">
							<tr>
								<th className="whitespace-nowrap px-1 md:px-16 lg:px-16 py-2 font-semibold text-gray-900">
									Sr. No.
								</th>
								<th className="whitespace-nowrap px-1 md:px-16 lg:px-16 py-2 font-semibold text-gray-900">
									Farmer Name
						...
						<div className="flex mt-8 justify-center items-center">
							<button
								...
								className={`inline-block w-full rounded-lg bg-black px-10 py-3 mx-10 font-medium text-white sm:w-auto ${
									saved || !allowed ? "opacity-20 cursor-progress" : ""
								}`}
							...
							<button
								...
								name="print"
								className={`inline-block w-full rounded-lg bg-black px-10 py-3 mx-10 font-medium text-white sm:w-auto ${
									print || !allowed ? "opacity-20 cursor-progress" : ""
								}`}
