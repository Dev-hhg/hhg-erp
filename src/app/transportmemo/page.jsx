  ...
  return (
    <div className="p-14">
      ...
      <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
        ...
        <h1 className="text-center text-3xl font-bold">Transporter Memo</h1>
        <div className="mt-8">
          <table className="mt-5 min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            <thead className="">
              <tr className="bg-gray-300">
                <th className="whitespace-nowrap px-1 py-2 font-bold text-gray-900 md:px-16 lg:px-16">
                  Sr. No
                </th>
                <th className="whitespace-nowrap px-1 py-2 font-bold text-gray-900 md:px-16 lg:px-16">
                  Vendor
            ...
            <tbody className="divide-y divide-gray-200">
              {entries.map((entry, index) => (
                ...
                >
                  ...
                  <td
                    className={`whitespace-nowrap py-2 text-center text-xl font-bold ${
