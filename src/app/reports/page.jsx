	...
	return (
		<div className="p-2 md:p-14 lg:p-14">
			...
			<div className=" overflow-x-auto rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-8 ">
				...
				<table className="w-full divide-y-2 divide-gray-200 bg-white text-sm mt-5 ">
					<thead className="border-b">
						<tr>
							<th className="whitespace-nowrap px-1 md:px-2 lg:px-2 py-2 font-bold text-gray-900 border-2">
								Sr. No.
							</th>
							<th className="whitespace-nowrap px-1 md:px-2 lg:px-2 py-2 font-bold text-gray-900 border-2">
								Item
									...
									<tr className="border-b">
										{index === 0 || Data[index - 1].item !== item.item ? (
											<td
												...
												className="whitespace-nowrap text-center py-2 text-gray-700 font-semibold border"
											>
												{index + 1}
											</td>
										) : null}
										...
										<td className="whitespace-nowrap text-center py-2 text-gray-700 border">
											{item.vendorname}
										</td>
										<td className="whitespace-nowrap text-center py-2 text-gray-700 border">
											{(Number(item.highest_rate) / 10).toLocaleString("en-IN")}
